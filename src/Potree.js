...
export {CustomControls} from "./navigation/CustomControls.js";
...
export function loadPointCloud(pointcloud_config, name, callback) {
	...
	let promise = new Promise(resolve => {
		...
		POCLoader.load(pointcloud_config, function (geometry) {
			if (!geometry) {
				console.error(new Error(`failed to load point cloud from config`), pointcloud_config);
			} else {
