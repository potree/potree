Potree.EptLoader = class EptLoader {
...
Potree.PointCloudEptGeometry = class PointCloudEptGeometry {
  constructor(url, info) {
    ...
    if (dataType == 'laszip') {
      ...
      this.loader = new Potree.EptZstandardLoader(this.version);
    } else {
...
Potree.PointCloudEptGeometryNode = class PointCloudEptGeometryNode extends Potree.PointCloudTreeNode {
  constructor(ept, b, d, x, y, z) {
    super();
...
Potree.PointCloudEptGeometryNode.IDCount = 0;