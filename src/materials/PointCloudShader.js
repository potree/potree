...
export class Potree_PointCloudShader extends GLShader {
  ...
  static getParamDeclarations() {
    ...
    paramDescs.push({ name: "size", type: "float", value: 1 })
    paramDescs.push({ name: "minSize", type: "float", value: 1 })
    paramDescs.push({ name: "maxSize", type: "float", value: 1 })
  ...
  */
    ...
    paramDescs.push({ name: "intensityBrightness", type: "float", value: 0 })
