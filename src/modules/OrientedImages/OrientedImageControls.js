...
export class OrientedImageControls extends EventDispatcher{
	...
	constructor(viewer){
		...
		// const style = ``;
		this.elUp =    $(`<input type="button" value="🡅" style="position: absolute; top: 10%; left: calc(50%); z-index: 1000" />`);
		this.elRight = $(`<input type="button" value="🡆" style="position: absolute; top: calc(50%); right: 20%; z-index: 1000" />`);
		this.elDown =  $(`<input type="button" value="🡇" style="position: absolute; bottom: 10%; left: calc(50%); z-index: 1000" />`);
		this.elLeft =  $(`<input type="button" value="🡄" style="position: absolute; top: calc(50%); left: 20%; z-index: 1000" />`);
