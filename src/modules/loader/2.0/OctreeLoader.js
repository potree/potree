...
export class NodeLoader{
	...
	try{
	    ...
	    let urlOctree = this.config.octree; // `${this.url}/../octree.bin`;
		...
		//geometry.center(); // FIXME: works for points, but not lines
	...
	let hierarchyPath = this.config.hierarchy; // `${this.url}/../hierarchy.bin`;
