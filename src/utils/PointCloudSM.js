...
const vs = require('../materials/shaders/pointcloud_sm.vs');
const fs = require('../materials/shaders/pointcloud_sm.fs');
...
class PointCloudSM {
	constructor (potreeRenderer) {
		...
		this.shader = new Shader(this.gl, 'shadow_map', vs(), fs());
