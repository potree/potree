...
function readUsingTempArrays (event) {
	...
	// TODO: unused: let sourceView = new DataView(buffer);
	...
	for (let i = 0; i < numPoints; i++) {
		...
		// TODO: unused: let intensity = tempUint16[0];
		// targetView.setFloat32(i * numPoints + 0, x, true);

		// RETURN NUMBER, stored in the first 3 bits - 00000111
		// TODO: unused: let returnNumber = sourceUint8[i * sourcePointSize + 14] & 7;
		...
		// CLASSIFICATION
		// TODO: unused: let classification = sourceUint8[i * sourcePointSize + 15];
		// classifications[i] = classification;

		// POINT SOURCE ID
		tempUint8[0] = sourceUint8[i * sourcePointSize + 18];
		tempUint8[1] = sourceUint8[i * sourcePointSize + 19];
		// TODO: unused: let pointSourceID = tempUint16[0];
...
function readUsingDataView (event) {
	...
	// TODO: unused: let sourceUint8 = new Uint8Array(buffer);
...
self.onmessage = readUsingDataView;
